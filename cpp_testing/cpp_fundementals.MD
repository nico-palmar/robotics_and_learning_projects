...
| `deque`         | O(n)     | O(1) ends | O(1) ends | O(n)      | Insertion |
...
- What happens during object construction/destruction order (base → members -> dervied for construction)
